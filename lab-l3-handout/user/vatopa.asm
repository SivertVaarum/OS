...
int main(int argc, char *argv[]){
   ...
   a:	1000                	addi	s0,sp,32
    ...
    if(argc != 3 && argc != 2){
   c:	ffe5071b          	addiw	a4,a0,-2
  10:	4785                	li	a5,1
  12:	04e7e363          	bltu	a5,a4,58 <main+0x58>
  16:	84ae                	mv	s1,a1
    ...
    if(argc == 3){
  18:	478d                	li	a5,3
  1a:	04f50c63          	beq	a0,a5,72 <main+0x72>
        vaddr = atoi(argv[1]);
        pid = atoi(argv[2]);
    }
    if(argc == 2){
  ...
  24:	1fa080e7          	jalr	506(ra) # 21a <atoi>
  28:	0ff57913          	zext.b	s2,a0
        pid = 0;
  2c:	4581                	li	a1,0
    }
  ...
  34:	39c080e7          	jalr	924(ra) # 3cc <va2pa>
  38:	85aa                	mv	a1,a0
  3a:	00001517          	auipc	a0,0x1
  3e:	84e50513          	addi	a0,a0,-1970 # 888 <malloc+0x12c>
  42:	00000097          	auipc	ra,0x0
  46:	662080e7          	jalr	1634(ra) # 6a4 <printf>
  ...
  5c:	80850513          	addi	a0,a0,-2040 # 860 <malloc+0x104>
  60:	00000097          	auipc	ra,0x0
  64:	644080e7          	jalr	1604(ra) # 6a4 <printf>
        exit(0);
  68:	4501                	li	a0,0
  6a:	00000097          	auipc	ra,0x0
  6e:	2aa080e7          	jalr	682(ra) # 314 <exit>
        vaddr = atoi(argv[1]);
  72:	6588                	ld	a0,8(a1)
  74:	00000097          	auipc	ra,0x0
  78:	1a6080e7          	jalr	422(ra) # 21a <atoi>
  7c:	0ff57913          	zext.b	s2,a0
        pid = atoi(argv[2]);
  80:	6888                	ld	a0,16(s1)
  82:	00000097          	auipc	ra,0x0
  86:	198080e7          	jalr	408(ra) # 21a <atoi>
  8a:	85aa                	mv	a1,a0
    if(argc == 2){
  8c:	b74d                	j	2e <main+0x2e>
...
free(void *ap)
{
 ...
 6e8:	d0c7b783          	ld	a5,-756(a5) # 13f0 <freep>
 ...
 710:	00e6ea63          	bltu	a3,a4,724 <free+0x4a>
{
 ...
 752:	caf73123          	sd	a5,-862(a4) # 13f0 <freep>
}
 756:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 77c:	c7853503          	ld	a0,-904(a0) # 13f0 <freep>
 ...
 7ac:	c4890913          	addi	s2,s2,-952 # 13f0 <freep>
  if(p == (char*)-1)
 7b0:	5afd                	li	s5,-1
 ...
 7c0:	c4478793          	addi	a5,a5,-956 # 1400 <base>
 7c4:	00001717          	auipc	a4,0x1
 7c8:	c2f73623          	sd	a5,-980(a4) # 13f0 <freep>
 7cc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83e:	baa73b23          	sd	a0,-1098(a4) # 13f0 <freep>
      return (void*)(p + 1);
