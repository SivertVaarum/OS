...
int main(int argc, char *argv[])
{
  ...
  14:	85098993          	addi	s3,s3,-1968 # 860 <malloc+0x11a>
  18:	a815                	j	4c <main+0x4c>
            printf("SYSCALL FAILED");
  1a:	00001517          	auipc	a0,0x1
  1e:	83650513          	addi	a0,a0,-1994 # 850 <malloc+0x10a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40a:	4ca50513          	addi	a0,a0,1226 # 8d0 <digits>
 40e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 510:	36c70713          	addi	a4,a4,876 # 878 <malloc+0x132>
 ...
 59c:	338b8b93          	addi	s7,s7,824 # 8d0 <digits>
 ...
 5f2:	28290913          	addi	s2,s2,642 # 870 <malloc+0x12a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d2:	d127b783          	ld	a5,-750(a5) # 13e0 <freep>
...
malloc(uint nbytes)
{
 ...
 766:	c7e53503          	ld	a0,-898(a0) # 13e0 <freep>
 ...
 796:	c4e90913          	addi	s2,s2,-946 # 13e0 <freep>
  if(p == (char*)-1)
 79a:	5afd                	li	s5,-1
 ...
 7aa:	c4a78793          	addi	a5,a5,-950 # 13f0 <base>
 7ae:	00001717          	auipc	a4,0x1
 7b2:	c2f73923          	sd	a5,-974(a4) # 13e0 <freep>
 7b6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 828:	baa73e23          	sd	a0,-1092(a4) # 13e0 <freep>
      return (void*)(p + 1);
