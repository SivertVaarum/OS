...
int main(int argc, char *argv[])
{
  ...
  4c:	83850513          	addi	a0,a0,-1992 # 880 <malloc+0x102>
  50:	00000097          	auipc	ra,0x0
  54:	676080e7          	jalr	1654(ra) # 6c6 <printf>
        printf("Usage: time [exec] [arg1 arg2 ...]\n");
  58:	00001517          	auipc	a0,0x1
  5c:	84050513          	addi	a0,a0,-1984 # 898 <malloc+0x11a>
  ...
  78:	84c50513          	addi	a0,a0,-1972 # 8c0 <malloc+0x142>
  ...
  aa:	84250513          	addi	a0,a0,-1982 # 8e8 <malloc+0x16a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	3cc70713          	addi	a4,a4,972 # 910 <malloc+0x192>
 ...
 5d4:	398b8b93          	addi	s7,s7,920 # 968 <digits>
 ...
 62a:	2e290913          	addi	s2,s2,738 # 908 <malloc+0x18a>
        while(*s != 0){
...
free(void *ap)
{
 ...
 70a:	cda7b783          	ld	a5,-806(a5) # 13e0 <freep>
...
malloc(uint nbytes)
{
 ...
 79e:	c4653503          	ld	a0,-954(a0) # 13e0 <freep>
 ...
 7ce:	c1690913          	addi	s2,s2,-1002 # 13e0 <freep>
  if(p == (char*)-1)
 7d2:	5afd                	li	s5,-1
 ...
 7e2:	c1278793          	addi	a5,a5,-1006 # 13f0 <base>
 7e6:	00001717          	auipc	a4,0x1
 7ea:	bef73d23          	sd	a5,-1030(a4) # 13e0 <freep>
 7ee:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 858:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 85c:	00001717          	auipc	a4,0x1
 860:	b8a73223          	sd	a0,-1148(a4) # 13e0 <freep>
      return (void*)(p + 1);
